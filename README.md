...
- 专注开始后自动显示屏幕顶部悬浮控制条，可随时暂停、继续、搜索并切换其他任务
...
7. 点击右上角“设置”，可切换语言、配置番茄钟与闲置检测、管理回收站、浏览/恢复自动备份，以及导入/导出 JSON。
8. 从右侧报告面板查看日、周、月战绩或导出 PDF。
9. 点击“桌面悬浮”打开常驻桌面的迷你任务板。
10. 在桌面空白处右键“编辑小组件”，搜索 TaskDeck，并选择小号、中号或大号。
